            ...
            <Container>
                <ColumnLeft>
                    ...
                    <Button
                        ...
                        whileTap={{ scale: 0.95, backgroundColor: '#fff', color: 'black'}}
                ...
                <ColumnRight>
                    <Image src={PlanetOne} alt='planet'
                           ...
                           animate={{opacity:1, y: 0, transition: { delay: 1.4, duration: 1 }}}
                    />
                    ...
                    <Image src={PlanetThree} alt='planet'
                           ...
                           initial={{ opacity: 0, x: 100 }}
                           animate={{opacity:1, x: 0, transition: { delay: 1.6, duration: 1 }}}
                    />
                    <Image src={PlanetFour} alt='planet'
                           ...
                           animate={{opacity:1, y: 0, x: 0, transition: { delay: 1.7, duration: 1 }}}
                    />
                </ColumnRight>
            </Container>
        </Section>
